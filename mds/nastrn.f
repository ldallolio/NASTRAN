      PROGRAM NASTRN
C       
      CHARACTER*200   VALUE, DSNAMES ! increase from 44 to 200
      CHARACTER*5     TMP
...
c      print *, achar(27)//'[34m', 'DIRCTY=', value, achar(27)//'[0m'
...
!      SDSN(10) = VALUE
     ...
     & OPEN ( 11, FILE=DSNAMES(11),STATUS='UNKNOWN')
      IF ( DSNAMES(12) .NE. 'none' .and. DSNAMES(12) .ne. ''  )
     & OPEN ( 12, FILE=DSNAMES(12),STATUS='UNKNOWN')
      IF ( DSNAMES(13) .NE. 'none' .and. DSNAMES(13) .ne. ''  )
     & OPEN ( 13, FILE=DSNAMES(13),STATUS='UNKNOWN')
      IF ( DSNAMES(76) .NE. 'none' .and. DSNAMES(76) .ne. ''  )
     & OPEN ( 76, FILE=DSNAMES(76),STATUS='UNKNOWN')
      IF ( DSNAMES(77) .NE. 'none' .and. DSNAMES(77) .ne. ''  )
