...
C        
C     JHALF  = 65535 = '0000FFFF'X (OR X'0000FFFF')        
...
C        
 ...
 1060 BD(1) = A(1)        
      ...
      GO TO 1090        
C1070 B(1)  = A(1)        
C     B(2)  = A(3)         ! A(3) SINCE DAY 1        
 1070 B(1)  = AD(1)        ! CHANGES MADE BY G.CHAN/UNISYS   1/91       
      B(2)  = AD(2)        
C        
 1090 NBRSTR= RSHIFT(ZZ(APOINT),IHALF)        
      INIT  = ANDF(ZZ(APOINT),JHALF)        
      IROW  = INIT*RCD - RCD + 1        
      NROW  = IROW + NBRSTR*RCD - 1        
      IPOINT= APOINT + PRCA - 1        
      J     = IPOINT/PRCA + 1        
C        
...
C        
 ...
 1250 J = J + RCA        
      APOINT = APOINT + NBRSTR*NWDA + PRCA        
      NBR  = NBR - 1        
...
C        
 1260 NBRSTR= RSHIFT(ZZ(APOINT),IHALF)        
      INIT  = ANDF(ZZ(APOINT),JHALF)        
      IROW  = INIT*RCD - RCD + 1        
      NROW  = IROW + NBRSTR*RCD - 1        
      IPOINT= APOINT + PRCA - 1        
...
C        
 1265 NBRSTR= RSHIFT(ZZ(APOINT),IHALF)        
      INIT  = ANDF(ZZ(APOINT),JHALF)        
      IROW  = INIT*RCD - RCD + 1        
      NROW  = IROW + NBRSTR*RCD - 1        
      IPOINT= APOINT + PRCA - 1        
...
C        
 1270 NBRSTR= RSHIFT(ZZ(APOINT),IHALF)        
      INIT  = ANDF(ZZ(APOINT),JHALF)        
      IROW  = INIT*RCD - RCD + 1        
      NROW  = IROW + NBRSTR*RCD - 1        
      IPOINT= APOINT + PRCA - 1        
...
C        
 1275 NBRSTR= RSHIFT(ZZ(APOINT),IHALF)        
      INIT  = ANDF(ZZ(APOINT),JHALF)        
      IROW  = INIT*RCD - RCD + 1        
      NROW  = IROW + NBRSTR*RCD - 1        
      IPOINT= APOINT + PRCA - 1        
...
C        
 ...
 1360 DROW  = AROW        
      ...
      NBRSTR= ZZ(L-1)        
 1370 NBR   = RSHIFT(ZZ(APOINT),IHALF)        
      NBR1  = NBR        
      INIT  = ANDF(ZZ(APOINT),JHALF)        
      IPOINT= APOINT + PRCA - 1        
      J     = IPOINT/PRCA + 1        
