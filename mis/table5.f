...
C        
  ...
  120 FORMAT (//5X,'TI PARAMETERS =',/4X,10(1X,I9))        
      ...
      J   = KORE - KK3 - 9        
      IF (J .LT. 0) GO TO 840        
C     IF (DEBUG) WRITE (6,130) KK,KK1,KK2,KK3,KORE        
C 130 FORMAT ('   KK,KK1,KK2,KK3,KORE = ',5I6)        
      DO 140 K = KK1,KK3        
  140 Z(K) = 0        
  ...
  150 IF (L .GE. 0) GO TO 170        
      ...
      TIL= TI(LL)        
C     IF (DEBUG) WRITE (6,160) LL,L,K,TIL        
C 160 FORMAT (/,' ...LL,L,K,TIL = ',3I5,I14)        
  ...
  170 TIL10 = TIL/10        
      Z(K+L)= TIL - TIL10*10        
      TIL   = TIL10        
C     IF (DEBUG) WRITE (6,180) K,L,Z(K+L),TIL        
C 180 FORMAT (22X,'K,L,Z(K+L),TIL = ',3I4,I12)        
      L  = L - 1        
      GO TO 150        
C        
  200 K  = KK2 - 1        
...
C        
  ...
  520 WRITE  (OUT,FMT,ERR=530) (RZ(J),J=IB,I)        
  530 IB  = I + 1        
      L5  = 0        
      L   = 1        
      FMT(1) = LPREN        
C        
  540 K   = K + 1        
      ...
      I   = I + 1        
C     IF (DEBUG) WRITE (6,550) IB,I,K,KK,L,L5        
C 550 FORMAT (15X,' IB,I,K,KK,L,L5/@540=',6I6)        
      L   = L + 1        
      J   = Z(K)        
...
C        
  ...
  670 CONTINUE        
      I   = K        
  680 WRITE (OUT,FMT,ERR=690) (RZ(J),J=IB,I)        
C        
