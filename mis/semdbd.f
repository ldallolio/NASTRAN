...
C
      COMMON /SEM   / MASK, MASK2, MASK3, NAME(15)
C
C     -------------------     / SYSTEM /     ---------------------------
C
...
C              FOR UNIX MACHINE
C     LEFT   = (5 UNUSED WORDS).  KSYS99 USED IN ERRTRC
C
C
      DIMENSION       DATE(3),SYSDAT(3),ADUMEL(9),MODCOM(9),HDY(3),
     1                SWITCH(3),K88 90(3) ,LEFT(5)
     ...
     9                K88 90,LPCH  ,LDICT ,IAEROT,KSYS94,SPERLK,LEFT
C
C     -------------------     / XFIST  /     ---------------------------
C
...
C
      COMMON /XFIAT / MFIAT, NFIAT, LFIAT, FIAT(880)
C
C     -------------------     / OSCENT /     ---------------------------
C
...
C     -------------------     /BLANK  /     --------------------------
C
      DATA    IBLNK /  56*0, 4H CEA, 4HSE E, 4HMPIR, 4HE >  /
C
C     -------------------     / NTIME  /     ---------------------------
C
      DATA    LNTIME/ 16      /
...
C
      DATA    MFIAT / 0 /, NFIAT / 80 /, LFIAT / 0 /, FIAT /
     1                0, 4HGEOM, 4H1   , 8*0 ,
     2                0, 4HEPT , 4H    , 8*0 ,
     3                0, 4HMPT , 4H    , 8*0 ,
     4                0, 4HEDT , 4H    , 8*0 ,
