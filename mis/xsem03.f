...
CZZ  6       /ZZXSEM/ DATABF(1)        
     ...
     4        IBLNK / 4H    /,EXIT  / 4HEXIT/        
      DATA    THISLK/ 3     /,SUBNAM/ 4HXSEM, 2H03  /        
...
C        
 ...
 1020 IF (MODX .GT. 92) GO TO 1030        
      I = MODX - 89        
      IF (I) 940,940,1015        
 1030 IF (MODX - 98) 940,2098,1040        
 1035 GO TO (2124,2125,2126), I        
 1040 IF (MODX .GT. 126) GO TO 1050        
      I = MODX - 123        
      IF (I) 940,940,1035        
 1045 GO TO (2139, 940,2141,2142), I        
 1050 IF (MODX .EQ. 214) GO TO 2214        
      IF (MODX .EQ. 215) GO TO 2215        
      IF (MODX .GT. 142) GO TO 1060        
      I = MODX - 138        
      IF (I) 940,940,1045        
 1060 IF (MODX - LXLINK) 940,940,970        
 2003 CALL XCHK        
      GO TO 10        
 2005 CALL XCEI        
      GO TO 10        
