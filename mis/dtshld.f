...
C
  ...
  730 CONTINUE
      ...
      END
C
C     THIS SUBROUTINE WAS RENUMBERD BY G.CHAN/UNISYS  8/1992
C
C                    TABLE OF OLD vs. NEW STATEMENT NUMBERS
C
C     OLD NO.    NEW NO.      OLD NO.    NEW NO.      OLD NO.    NEW NO.
C    --------------------    --------------------    -------------------
C        109         10          665        250          301        490
C        120         20          670        260          235        500
C        146         30          230        270           70        510
C        110         40         3101        280           80        520
C        115         50         3103        290          310        530
C        128         60         3105        300          303        540
C        156         70         3107        310          304        550
C        211        -80         3109        320          305        560
C        158         90         3111        330          320        570
C        102        100         3113        340          350        580
C        105        110         3115        350          330        590
C        258        120          179        360          355        600
C         42        130          276        370          356        610
C        130        140          277        380          363        620
C        132        150          278        390          380        630
C        133        160          281        400
C         50        170          282        410          307        650
C        600        180          283        420          904        660
C         55        190          286        430          905        670
C         75        200          287        440         7504        700
C        700        210          288        450         7505        710
C        218        220          293        460         7506        720
C        219        230          292        470          999        730
C       2190        240
