...
CZZ  6       /ZZXSEM/ DATABF(1)        
     ...
     4        IBLNK / 4H    /,EXIT  / 4HEXIT/        
      DATA    THISLK/ 13    /,SUBNAM/ 4HXSEM, 2H13/        
...
C        
 ...
 1000 IF (MODX .GT. 12) GO TO 1010        
      I = MODX - 2        
      IF (I) 940,940, 995        
 1010 IF (MODX -  24) 940,2024,1020        
 1020 IF (MODX -  34) 940,2034,1030        
 1030 IF (MODX -  58) 940,2058,1040        
 1035 GO TO (2069,2070), I        
 1040 IF (MODX .GT. 70) GO TO 1050        
      I = MODX - 68        
      IF (I) 940,940,1035        
 1045 GO TO (2090,2091,2092), I        
 1050 IF (MODX .GT. 92) GO TO 1060        
      I = MODX - 89        
      IF (I) 940,940,1045        
 1055 GO TO (2099,2100,2101), I        
 1060 IF (MODX .GT. 101) GO TO 1070        
      I = MODX - 98        
      IF (I) 940,940,1055        
 1065 GO TO (2119,940,2121,940,940,2124), I        
 1070 IF (MODX .GT. 124) GO TO 1080        
      I = MODX - 118        
      IF (I) 940,940,1065        
 1075 GO TO (2139,940,2141,2142), I        
 1080 IF (MODX .GT. 142) GO TO 1085        
      I = MODX - 138        
      IF (I) 940,940,1075        
 1085 IF (MODX .EQ. 162) GO TO 2162        
      IF (MODX .GT. 197) GO TO 1090        
      I = MODX - 187        
      IF (I) 940,940,1086        
 1086 GO TO (2188,2189,2190,2191,2192,2193,2194,2195,940,2197), I       
 1090 IF (MODX .EQ. 214) GO TO 2214        
      IF (MODX .EQ. 215) GO TO 2215        
      IF (MODX-LXLINK) 940,940,970        
 2003 CALL XCHK        
      GO TO 10        
 2005 CALL XCEI        
      GO TO 10        
