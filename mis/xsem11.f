...
CZZ  6       /ZZXSEM/ DATABF(1)        
     ...
     4       IBLNK  / 4H    /,EXIT   / 4HEXIT/        
      DATA   THISLK / 11    /,SUBNAM / 4HXSEM, 2H11  /        
...
C        
 ...
 1000 IF (MODX .GT. 12) GO TO 1010        
      I = MODX - 2        
      IF (I) 940,940,995        
 1010 IF (MODX -  23) 940,2023,1020        
 1015 GO TO (2044,2045), I        
 1020 IF (MODX .GT. 45) GO TO 1030        
      I = MODX - 43        
      IF (I) 940,940,1015        
 ...
 1055 GO TO (2139,940,2141,2142,940,940,2145,2146), I        
 1060 IF (MODX .GT. 146) GO TO 1070        
      I = MODX - 138        
      IF (I) 940,940,1055        
 1070 IF (MODX .GT. 215) GO TO 1080        
      I = MODX - 214        
      IF (I) 940,2214,2215        
