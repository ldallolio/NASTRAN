...
C     WRITE (6,149)
C     DO 1280 I = 1,81,3
C1280 WRITE (6,159) A(I),A(I+1),A(I+2)
C
...
C
C     WRITE (6,249) (T(I),I=1,9)
C     WRITE (6,259) (TITE(I),I = 1,9)
C
      GO TO 260
C
  240 DO 250 K = 1,9
...
C
C     IF (NPIVOT .NE. J) WRITE (6,279) (M6X6(I),I=1,36)
C
...
C
  ...
  310 TJTE(I+ 3) = 0.0D0
C
C     WRITE (6,299) (T(I),I=1,9)
C     WRITE (6,269) (TJTE(I),I=1,36)
C
      GO TO 340
C
  320 DO 330 I = 1,3
...
C
C 109 FORMAT (1H1)
C 119 FORMAT (15H MQDPLT PRINTER)
C1195 FORMAT (15X,1H1,18X,2HD1,18X,2HD2,18X,2HA1, /5X,4D20.5, /,
C    1       (25X,3D20.5))
C 129 FORMAT (15X,5HIVECT,5X,3D20.5,/15X,5HJVECT,5X,3D20.5,/15X,5HKVECT,
C    1        5X,3D20.5,//7X,13HR COORDINATES,5X,4D20.5,/25X,4D20.5)
