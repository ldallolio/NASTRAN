...
CZZ  6       /ZZXSEM/ DATABF(1)        
     ...
     4        IBLNK / 4H    /,EXIT  / 4HEXIT/        
      DATA    THISLK/ 6     /,SUBNAM/ 4HXSEM, 2H06  /        
...
C        
 ...
 1000 IF (MODX .GT. 12) GO TO 1010        
      I = MODX - 2        
      IF (I) 940,940,995        
 1010 IF (MODX -  32) 940,2032,1020        
 1015 GO TO (2069,2070), I        
 1020 IF (MODX .GT. 70) GO TO 1030        
      I = MODX - 68        
      IF (I) 940,940,1015        
 1025 GO TO (2090,2091,2092), I        
 1030 IF (MODX .GT. 92) GO TO 1040        
      I = MODX - 89        
      IF (I) 940,940,1025        
 1040 IF (MODX - 114) 940,2114,1050        
 1050 IF (MODX - 124) 940,2124,1060        
 1055 GO TO (2139, 940,2141,2142), I        
 1060 IF (MODX .GT.142) GO TO 1070        
      I = MODX - 138        
      IF (I) 940,940,1055        
 1070 IF (MODX - 207) 940,2207,1075        
 1075 IF (MODX .GT. 215) GO TO  1080        
      IF (MODX - 214) 940,2214,2215        
