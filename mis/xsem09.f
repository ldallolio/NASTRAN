...
CZZ  6       /ZZXSEM/ DATABF(1)        
     ...
     4        IBLNK / 4H    /,EXIT  / 4HEXIT/        
      DATA    THISLK/ 9     /,SUBNAM/ 4HXSEM, 2H09  /        
...
C        
 1000 IF (MODX .GT. 12) GO TO 1010        
      I = MODX - 2        
      IF (I .LE. 0) GO TO 940        
      GO TO (2003, 940,2005,2006,2007,2008,2009,2010,2011,2012), I      
 1010 IF (MODX .GT. 18) GO TO 1020        
      I = MODX - 15        
      IF (I .LE. 0) GO TO 940        
      GO TO (2016,2017,2018), I        
 1020 IF (MODX - 50) 940,2050,1030        
 ...
 1040 IF (MODX .GT. 92) GO TO 1050        
      I = MODX - 89        
      IF (I .LE. 0) GO TO 940        
      GO TO (2090,2091,2092), I        
 1050 IF (MODX - 124) 940,2124,1060        
 1060 IF (MODX .GT. 144) GO TO 1070        
      I = MODX - 138        
      IF (I .LE. 0) GO TO 940        
      GO TO (2139, 940,2141,2142, 940,2144), I        
 1070 IF (MODX - 184) 940,2184,1080        
 1080 IF (MODX .EQ. 208) GO TO 2208        
      IF (MODX .EQ. 214) GO TO 2214        
