...
C
   30 SP = TEMP1/SL
      CP = TEMP2/SL
C     WRITE (6,119) RA,RB,ZA,ZB,SL,SP,CP
C
...
C     WRITE (6,129) A0,A1,A2,A3,B0,B1,B2,B3,C0,C1,D0,D1
C
...
C
      RETURN
C
C 109 FORMAT(15H ECPT FOR DCONE,/4(16X,I10),6X,E20.8/2(16X,I10,6X,E20.8)
C    1,6X,E20.8/5(6X,E20.8)/5(6X,E20.8)/5(6X,E20.8)/6X,E20.8,16X,I10,3(6
C    2X,E20.8)/16X,I10,4(6X,E20.8)/5(6X,E20.8)/5(6X,E20.8)/5(6X,E20.8)/)
C 119 FORMAT(5X5HRA = ,D20.8,5X,5HRB = ,D20.8,5X,5HZA = ,D20.8,5X5HZB =
C    1,D20.8/1X,9HLENGTH = ,D20.8,4X,6HSIN = ,D20.8,4X6HCOS = ,D20.8/)
C 129 FORMAT(5X5HA0 = ,D20.8,5X,5HA1 = ,D20.8,5X,5HA2 = ,D20.8,5X5HA3 =
C    1,D20.8/5X5HB0 = ,D20.8,5X,5HB1 = ,D20.8,5X,5HB2 = ,D20.8,5X5HB3 =
C    2,D20.8/5X5HC0 = ,D20.8,5X,5HC1 = ,D20.8,5X,5HD0 = ,D20.8,5X5HD1 =
C    3,D20.8/)
C
      END
