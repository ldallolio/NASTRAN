...
CZZ  6       /ZZXSEM/ DATABF(1)        
     ...
     4       IBLNK  / 4H    /,EXIT   / 4HEXIT/        
      DATA   THISLK / 10    /,SUBNAM / 4HXSEM, 2H10  /        
...
C        
 ...
 1000 IF (MODX .GT. 12) GO TO 1010        
      I = MODX - 2        
      IF (I) 940,940,995        
 1005 GO TO (2019,2020), I        
 1010 IF (MODX .GT. 20) GO TO 1020        
      I = MODX - 18        
      IF (I) 940,940,1005        
 1015 GO TO (2047,2048,940,940,2051,2052), I        
 1020 IF (MODX .GT. 52) GO TO 1030        
      I = MODX - 46        
      IF (I) 940,940,1015        
 ...
 1070 IF (MODX .GT. 142) GO TO 1080        
      I = MODX - 138        
      IF (I) 940,940,1065        
 1075 GO TO (2180,2181,2182,2183), I        
 1080 IF (MODX .GT. 183) GO TO 1085        
      I = MODX - 179        
      IF (I) 940,940,1075        
