...
C     WRITE(6,1590)
C     WRITE(6,159)  (S(I), I=1,18)
C     WRITE(6,1594)
C     WRITE(6,1595) (HINV(I), I=1,36)
C
...
C
C     WRITE(6,179)
C     WRITE(6,189) TEMP1, L1, S1, C1, X1, Y1, TEMP2, L2, S2, C2, X2, Y2
C     WRITE(6,199) (HQ(I), I =1,12)
C
C
C                      I                    -1
...
C
      ...
      HABC(18) = PROD12(12)
C
C     WRITE(6,209) (PROD12(I), I = 1,12)
C     WRITE(6,219) (HABC(I), I = 1,18)
C
