...
CZZ  6       /ZZXSEM/ DATABF(1)        
     ...
     4        IBLNK / 4H    /,EXIT  / 4HEXIT/        
      DATA    THISLK/ 12    /,SUBNAM/ 4HXSEM, 2H12  /        
...
C        
 ...
 1000 IF (MODX .GT. 12) GO TO 1010        
      I = MODX - 2        
      IF (I) 940,940,995        
 1005 GO TO (2027,2028,2029), I        
 1010 IF (MODX .GT. 29) GO TO 1020        
      I = MODX - 26        
      IF (I) 940,940,1005        
 ...
 1020 IF (MODX .GT. 70) GO TO 1030        
      I = MODX - 68        
      IF (I) 940,940,1015        
 1030 IF (MODX - 76) 940,2076,1040        
 1035 GO TO (2090,2091,2092), I        
 1040 IF (MODX .GT. 92) GO TO 1050        
      I = MODX - 89        
      IF (I) 940,940,1035        
 1050 IF (MODX - 118) 940,2118,1060        
 1060 IF (MODX - 124) 940,2124,1070        
 1065 GO TO (2139,940,2141,2142), I        
 1070 IF (MODX .GT. 142) GO TO 1080        
      I = MODX - 138        
      IF (I) 940,940,1065        
 1080 IF (MODX .EQ. 151) GO TO 2151        
      IF (MODX .EQ. 179) GO TO 2179        
      IF (MODX .GT. 215) GO TO 1100        
      I = MODX - 214        
      IF (I) 940,2214,2215        
 1100 IF (MODX-LXLINK) 940,940,970        
 2003 CALL XCHK        
      GO TO 10        
 2005 CALL XCEI        
      GO TO 10        
