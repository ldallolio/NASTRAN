...
C        
C     WRITE (6,4004) FI1,FI2,FJK,T,RA,RV1,RV2,RT,RB0,RB1,R2,ST,CT,      
C    1               S2T,C2T        
C4004 FORMAT (1X,9HCONSTANTS,/,2(10E10.5/))        
      DO 50 I = 1,6        
      DO 50 K = I,6        
      F(I,K)  = 0.0        
   50 CONTINUE        
...
C        
      ...
      S(K,I)   = S(I,K)        
  165 CONTINUE        
C     WRITE  (6,4000) (KE(I),I=1,144),((H(I,J),I=1,6),J=1,6)        
C4000 FORMAT (1X,24(6D20.6/)1X,4HH   /6(6D20.6/))        
C        
      J = 0        
