...
C     SEARCH TABLE LIST
C
C  90 IF (ITID.LE.0 .OR. ITID.GT.9999999) GO TO 110
   90 L = NUMTYP(ITID)
...
C
      IQ1 = IZ(IQ)
      Q1  = Z(IQ)
C     IF (IQ1.LE.0 .OR. IQ1.GT.1000000) GO TO 202
      LX  = NUMTYP(IQ1)
  ...
  202 IQ2 = IZ(IQ+1)
      Q2  = Z(IQ+1)
C     IF (IQ2.LE.0 .OR. IQ2.GT.1000000) GO TO 204
      LX  = NUMTYP(IQ2)
  ...
  204 IQ3 = IZ(IQ+2)
      Q3  = Z(IQ+2)
C     IF (IQ3.LE.0 .OR. IQ3.GT.1000000) GO TO 206
      LX  = NUMTYP(IQ3)
