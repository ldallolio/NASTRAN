...
CZZ  6       /ZZXSEM/ DATABF(1)        
     ...
     4        IBLNK / 4H    /,EXIT  / 4HEXIT/        
      DATA    THISLK/ 8     /,SUBNAM/ 4HXSEM, 2H08/        
...
C        
 ...
 1000 IF (MODX .GT. 12) GO TO 1010        
      I = MODX - 2        
      IF (I) 940,940,995        
 1010 IF (MODX - 26) 940,2026,1020        
 1015 GO TO (2042,2043), I        
 1020 IF (MODX .GT. 43) GO TO 1030        
      I = MODX - 41        
      IF (I) 940,940,1015        
 1025 GO TO (2069,2070), I        
 1030 IF (MODX .GT. 70) GO TO 1040        
      I = MODX - 68        
      IF (I) 940,940,1025        
 1040 IF (MODX -  83) 940,2083,1050        
 1045 GO TO (2090,2091,2092), I        
 1050 IF (MODX .GT. 92) GO TO 1060        
      I = MODX - 89        
      IF (I) 940,940,1045        
 1060 IF (MODX - 107) 940,2107,1070        
 1070 IF (MODX - 124) 940,2124,1080        
 1075 GO TO (2139,940,2141,2142), I        
 1080 IF (MODX .GT. 142) GO TO 1090        
      I = MODX - 138        
      IF (I) 940,940,1075        
 1090 IF (MODX - 185) 940,2185,1095        
 1095 IF (MODX - 214) 940,2214,1100        
 1100 IF (MODX .EQ. 215) GO TO 2215        
