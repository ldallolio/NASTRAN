...
CZZ   COMMON /ZZGNFL/  Z(1)
      COMMON /ZZZZZZ/  Z(1)
      EQUIVALENCE      (SCR,P1)
      DATA    NAME  /  4HGINO,4HFL  /,  SCRA, TCH / 4HSCRA, 4H     /
      DATA    BLANK /  4H           /,  IZ2 / 2   /,OUTFL  / 201   /
...
C
      ...
      CALL READ (*250,*140,SCRX,Z,2,1,K)
  140 IF (Z(1).NE.SCRA .OR. Z(IZ2).NE.TCH) CALL BCKREC (SCRX,1)
      NCOL = 0
